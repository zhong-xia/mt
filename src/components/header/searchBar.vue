    ...
    <div class="search-panel">
        <el-row class="m-header-searchbar">
            <el-col :span="3" class="left">
                <img src="//s0.meituan.net/bs/fe-web-meituan/b13d535/img/logo.png" alt="美团">
            </el-col>
  ...
  methods: {
    ...
    input(){
      ...
      api.getSearchList().then(res=>{
       this.searchList = res.data.data.list.filter((item,index) =>{//过滤
         return item.indexOf(val) > -1;//>-1存在关键字
       });
      })
    }
  }
